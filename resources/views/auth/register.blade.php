...
<head>
    ...
    <title>BKK BISA | Portal Lowongan Kerja</title>
    ...
    <link rel="icon" href="{{asset('temp/assets/img/core-img/logo.png')}}">
    ...
    <div class="login-wrapper d-flex align-items-center justify-content-center text-center">
            ...
            <div class="container">
                <div class="row justify-content-center">
                    <img class="img-thumbnail" src="http://2.bp.blogspot.com/-OCnppx_McYc/UU0Yy3CsUfI/AAAAAAAAADQ/-NEjmjoQ4uQ/s1600/smk+muthia+harapan.jpg" style="width: 120px;;" alt="">
                    <div class="col-12 col-sm-9 col-md-7 col-lg-6 col-xl-5"><h4 class="text-warning"><b>BKK SMK MUTHIA HARAPAN</b></h4>
                    <div class="register-form  px-4">
                    <form method="POST" action="{{ route('register') }}">
                        @csrf
                        <div class="">
                            <label for="name" class="col-md-4 col-form-label text-md-end font-fammily-cursive"><b>{{ __('Name') }}</b></label>
                            <input id="name" type="text" style="border:1px #ffc107 solid;width:100%;" class="form-control @error('name') is-invalid @enderror" name="name" value="{{ old('name') }}" required autocomplete="name" autofocus>
                                @error('name')
                        ...
                        <div class="">
                            ...
                            <input id="email" type="email" style="border:1px #ffc107 solid;width:100%;" class="form-control @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" required autocomplete="email">
                                @error('email')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="">
                            ...
                            <input id="password" type="password" style="border:1px #ffc107 solid;width:100%;" class="form-control @error('password') is-invalid @enderror" name="password" required autocomplete="new-password">
                                @error('password')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="">
                            ...
                            <input id="password-confirm" type="password" style="border:1px #ffc107 solid;width:100%;" class="form-control" name="password_confirmation" required autocomplete="new-password"> 
...
<br>
                        ...
                        <div class="login-meta-data"><a class="forgot-password d-block mt-3 mb-1" href="https://m.bkkbisa.com/auth/forgot_password">Lupa Password ?</a>
                        </div>
        ...
        <div class="container h-100 px-0">
            <div class="suha-footer-nav h-100 bg-dark text-white">
                <ul class="h-100 d-flex align-items-center justify-content-between ps-0 bg-warning">
                    <li class="active"><a href="{{ url('/') }}"><i class="lni text-white lni-home"></i>Home</a></li>
